...
| AU-2 | Event Logging | S3 server access logging to separate bucket | `infrastructure/s3-bucket.tf` | Checkov CKV_AWS_18 PASS |
...
| SC-13 | Cryptographic Protection | KMS customer-managed key + bucket SSE | `infrastructure/s3-bucket.tf` | Checkov CKV_AWS_19 PASS + AWS API confirms |
